...
TheraNotes 是一款專為心理健康從業人員設計的**個人諮商紀錄管理系統**，提供安全的本機資料儲存、自動儲存功能，以及便捷的諮商紀錄管理。
...
TheraNotes 採用現代化技術，確保效能、安全性與使用者體驗：
...
1. 開啟自動備份或定期備份資料庫檔案（`TheraNotes.db`）
...
- **Email**：[contact@theranotes.net](mailto:contact@theranotes.net)
- 詳細描述您遇到的問題或建議內容
- 附上螢幕截圖或錯誤訊息（如有）
